...
public class WolfBoss_idle : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if(playerTransform != null) {
            ...
            if(wolfBoss.currentHealth > (wolfBoss.enemyHealth / 2)){
                if(Vector2.Distance(playerTransform.position, rb.position) <= attackRange && wolfBoss.duringCooldown == false) {
