...
public class FinalBoss_Idle : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
       if(playerTransform != null) {
            ...
            if(finalBoss.currentHealth <= finalBoss.enemyHealth / 2) {
                ...
                else if(Vector2.Distance(rb.position, playerTransform.position) <= attackRange && 
                    Vector2.Distance(rb.position, playerTransform.position) > minRange) {
                    if(finalBoss.duringAttackCooldown == false) {
