...
/*
Controll movement and stats of the ApeMummy enemy
*/
public class ApeMummy : Enemy
{
    ...
    private void OnCollisionEnter2D(Collision2D other) {
        ...
        if(other.gameObject.CompareTag("Environment") && currentState == EnemyStates.enemymove) {
